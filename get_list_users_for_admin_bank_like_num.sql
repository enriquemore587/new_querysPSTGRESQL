CREATE OR REPLACE FUNCTION "cw"."get_list_users_for_admin_bank_like_num"(
...
BEGIN
		...
		WHERE u.active IS TRUE 
				...
				AND (u.num_client LIKE in_value||'%')
    LOOP
...
SELECT cw.get_list_users_for_admin_bank_like_num(5,'1');